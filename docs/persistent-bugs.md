...
- **Still to come (Part 3):** a shared loading indicator during the deferred rebuild (rule 46), per the owner's "loading hydration". Then persist the standing rule (`#remember`) for optimistic mutation.
