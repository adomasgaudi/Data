        ...
        did = g.exercises
          .map((e) => {
            ...
            const addBtn = S.showAddSets
              ...
              : "";
            return `<div class="wo-ex-line"><span class="wo-exname" title="${escapeHtml(e.exerciseName)}">${escapeHtml(name)}</span>${rmTxt} <span class="wo-setlist">${setsTxt}</span>${addBtn}</div>`;
          })
          .join("");
      } else {
