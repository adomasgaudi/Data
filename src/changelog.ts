...
export const RELEASES: Release[] = [
  { version: "b.2.4.1", title: "Weight Range bars sectioned by rep", sp: 3, note: "Each bar on the Weight Range graph is now split into one section per rep of that set. The bottom section starts at the weight you lifted (e.g. 80 kg = a 1-rep max of 80), and each section above it ends at what that same weight estimates as a 1RM for one more rep — 80×2, 80×3, … up to the top, which is the full estimated 1RM at your logged rep count. Alternating shading and a thin divider tick mark each rep, so a single bar reads as its rep-by-rep 1RM ladder." },
