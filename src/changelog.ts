...
export const CHANGELOG: Release[] = [
  ...
  },
  {
    ...
    children: [
      { version: "b.2.1.46", title: "Top Log in when spectating", sp: 0.5, note: "When you're logged out (spectator), a “Log in” button now sits up top next to the “Adomas (logged out)” badge — so you can jump back to the sign-in screen without opening Settings." },
