...
export const CHANGELOG: Release[] = [
  ...
  },
  {
    ...
    title: "v2-milestone",
    sp: 0, // auto-computed below = sum of children
    note: "Version 2: a polished, self-updating app — real-time charts, every lift on its own, one-click refresh from StrengthLevel, and a clean settings UI.",
    details: [
      "Builds on the b.1.14 run: live refresh, real time-axis charts, ungrouped exercises, tidied chrome.",
      "From here, b.2.x patches build on this foundation.",
    ],
    children: [
      { version: "b.2.0.42", sp: 1, note: "The drill-in “＋ combine with…” picker now uses the app's own dropdown, so it looks the same on every phone." },
      { version: "b.2.0.41", sp: 1, note: "Fixed Compare-graph bars that wouldn't hide, and moved the ✦ combined lifts (SQ mix, DL pattern) to a group at the top of the leaderboard picker." },
      { version: "b.2.0.40", sp: 3, note: "“SQ mix” and “DL pattern” (marked ✦) are now selectable in the leaderboard and Compare graph, so you can rank or chart them like any lift." },
      { version: "b.2.0.39", sp: 5, note: "Index inspector: tap an exercise to see its tags, its combine/compare group, and its active status — plus “Always show / hide” toggles." },
      { version: "b.2.0.38", sp: 1, note: "Calculator's Nuzzo graph now plots bar weight (kg) on the x-axis — “at this weight you can do N reps” — with your set as the gold dot." },
      { version: "b.2.0.37", sp: 8, note: "New app-wide “active exercises” filter: pick a frequency tier and the whole app narrows to your most-trained lifts (off by default)." },
      { version: "b.2.0.36", sp: 5, note: "“SQ mix” and “DL pattern” now exist as their own derived lifts (the real lifts are untouched). Groundwork — selectable next." },
      { version: "b.2.0.35", sp: 1, note: "Year heatmap “Tag alone” button: tap many days at once to add/remove the red “alone” ring without scrolling." },
      { version: "b.2.0.34", sp: 2, note: "The reps-at-%1RM research page and Calculator graph share one scroll/zoom chart, with your set as a gold dot." },
      { version: "b.2.0.33", sp: 5, note: "Groundwork: all the ways the app groups lifts now live in one registry (no visible change, locked by tests)." },
      { version: "b.2.0.31", sp: 1, note: "Removed the three throwaway graph test-pages from the Other menu." },
      { version: "b.2.0.30", sp: 0.1, note: "Workouts list now shows 50 entries per page (was 20)." },
      { version: "b.2.0.29", sp: 2, note: "The per-set RIR picker is now a custom dropdown that looks the same on every phone." },
      { version: "b.2.0.28", sp: 1, note: "Workouts “alone” filter is now one cycling button (Both → Only alone → Not alone)." },
      { version: "b.2.0.27", sp: 0.5, note: "Year heatmap rings any “trained alone” day with a red outline; updates live." },
      { version: "b.2.0.26", sp: 1, note: "Per-set difficulty switched from RPE to RIR (Reps In Reserve), with 11 descriptive bands. Old RPE values don't carry over." },
      { version: "b.2.0.25", sp: 0.1, note: "Year heatmap day numbers turned down further (barely-there)." },
      { version: "b.2.0.24", sp: 0.1, note: "Year heatmap day numbers centred and much fainter." },
      { version: "b.2.0.23", sp: 0.5, note: "Year heatmap squares show a tiny day number; Workouts defaults to By week + Muscle groups, heatmap to Legs." },
      { version: "b.2.0.22", sp: 0.5, note: "Sign-in is remembered: skip the landing gate on later visits (no flash)." },
      { version: "b.2.0.21", sp: 0.5, note: "Decorative landing gate with a “Sign in as admin” button (no real auth)." },
      { version: "b.2.0.20", sp: 0.5, note: "Year heatmap heat colours re-scaled — blue for 1–5 sets, gold for 6+." },
      { version: "b.2.0.19", sp: 0.5, note: "Year heatmap rest days now alternate by month (white vs light gray) instead of a warm tint." },
      { version: "b.2.0.18", sp: 3, note: "Grade how hard each set felt: an RPE (1–10) picker on every set, saved on the device, shown in the tooltip." },
      { version: "b.2.0.17", sp: 1, note: "Sets/week bars: translucent fill and squished further so they don't overlap the 1RM data." },
      { version: "b.2.0.16", sp: 1, note: "Sets/week bars 30% thinner, outline-only, sitting low so they don't tower over the 1RM data." },
      { version: "b.2.0.15", sp: 5, note: "Combine lifts in a drill-in: a “＋ combine with…” picker views e.g. Squat + Smith Squat as one. Moved “Center” into the controls." },
      { version: "b.2.0.14", sp: 1, note: "Sets/week bars are as wide as the week (histogram-style); muscle-group view reads “Quads — 4 sets”." },
      { version: "b.2.0.13", sp: 5, note: "Drill-in graph merged into ONE chart — every view is a legend toggle (1RM dots, current strength, per-set, sets/week, trend)." },
      { version: "b.2.0.12", sp: 1, note: "1RM-trend graph: each week's est-1RM is a scatter of dots, not a line. The current-strength line stays." },
      { version: "b.2.0.11", sp: 2, note: "Index: tap an exercise to expand its info — category, muscle, tier, total sets, who trains it, best 1RM and dates." },
      { version: "b.2.0.10", sp: 1, note: "Exercises list: the active period is always shown above the list and tappable to change." },
      { version: "b.2.0.9", sp: 1, note: "Renamed the all-exercises / body-parts page to “Index”; added a one-line explainer." },
      { version: "b.2.0.8", sp: 1, note: "The athlete chip row sticks to the top while scrolling, and the selected athlete scrolls into view." },
      { version: "b.2.0.7", sp: 3, note: "Graphs with 2+ lines: tap a legend key to show/hide that series. Keeps your pan/zoom." },
      { version: "b.2.0.6", sp: 5, note: "“Current strength” line on every 1RM graph — the best est-1RM reached so far (never drops)." },
      { version: "b.2.0.5", sp: 2, note: "Exercise drill-in: an “ℹ Exercise info” button jumps to that lift's row on the Exercises page." },
      { version: "b.2.0.4", sp: 3, note: "New “Site map” tab: a colour-coded mind map of every tab and what's inside it." },
      { version: "b.2.0.3", sp: 3, note: "Version history shows a “story points over time” line on a real time axis." },
      { version: "b.2.0.2", sp: 2, note: "Compare graph lists the actual sets behind it (date · exercise · weight×reps · est 1RM)." },
      { version: "b.2.0.1", sp: 2, note: "Workouts: a “Show” toggle to list each session by muscle group with set counts." },
