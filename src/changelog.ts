...
export const CHANGELOG: Release[] = [
  ...
  },
  {
    ...
    children: [
      { version: "b.2.0.42", sp: 1, note: "The drill-in “＋ combine with…” picker is now the app's own HTML/CSS dropdown (matching every other picker), not the raw OS one — consistent look on every phone, with click-outside-to-close." },
      { version: "b.2.0.41", sp: 1, note: "Fixed the “Showing period” control lingering on the Compare graph (and the drill-in): a class display rule was overriding the hidden attribute, so several bars never actually hid — now [hidden] always wins. Also surfaced the synthetic ✦ lifts (SQ mix, DL pattern) in a labelled “Combined lifts” group at the TOP of the leaderboard picker instead of buried at the bottom." },
