    ...
    children: [
      {
        ...
        children: [
          { version: "b.2.10.9", title: "Metadata inference + audits", sp: 8, note: "The exercise library now fills in its own anatomy. A keyword-inference table reads each lift's name and assigns its joints and movements (and, through those, its planes) — so “Leg Curl”, “Seated Cable Row”, “Hammer Curl” and dozens more get metadata automatically and the Filters in Workout analysis work on them straight away; anything the rules don't recognise is left blank rather than guessed wrong. A one-pass bulk tool can apply this across the whole library without editing lifts one by one. Two new Data-health checks: a “possible duplicates to review” list (look-alike names — shown, never merged automatically) and a “custom-exercise links to fix” report that flags broken variant/group links (a dissolved lift with a missing or self-referential parent, a combined/comparison group with too few members or a member that doesn't exist). 16 new tests; nothing destructive happens automatically." },
          { version: "b.2.10.8", title: "Enhancements backlog", sp: 1, note: "A prioritised future-ideas wishlist (docs/enhancements-backlog.md), kept separate from open bugs and from the technical-debt report." },
          { version: "b.2.10.7", title: "Heatmap week-row size", sp: 0.1, note: "Tuned the timeline heatmap's week-row sizing." },
          { version: "b.2.10.6", title: "Heatmap week rows", sp: 3, note: "The timeline heatmap groups cells into week rows." },
          { version: "b.2.10.5", title: "Heatmap scroll to end", sp: 1, note: "The heatmap scrolls to the most recent week on open." },
          { version: "b.2.10.4", title: "Multi-category heatmap CSS", sp: 0.5, note: "Styling for the multi-category heatmap." },
          { version: "b.2.10.3", title: "Multi-category heatmap", sp: 5, note: "The timeline heatmap can show multiple categories at once." },
          { version: "b.2.10.2", title: "Heatmap set tiers", sp: 2, note: "Heatmap cells are shaded by set-tier intensity." },
          { version: "b.2.10.1", title: "Analysis tab in nav", sp: 2, note: "The Workout-analysis view gets its own entry in the main navigation." },
        ],
      },
      {
