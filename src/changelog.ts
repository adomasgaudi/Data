    ...
    children: [
      {
        ...
        children: [
          { version: "b.2.3.10", title: "Analysis is the single home", sp: 8, note: "The Workouts | List & stats | Compare | Single tab bar above the athlete view is gone. Every exercise view now lives inside the unified Analysis view: tapping an exercise row, a Workouts-list lift, the Single back/switch dropdown, or any deep-link (#single=, #compare=, #all/#list) all route through Analysis and let the selection drive the mode (none → all · one → single · two-plus → compare). Bottom nav drops the Exercises button — it's just Analysis · More now — and Analysis is the default landing view. One way in, one place to be." },
