/**
 * From-scratch SVG chart engine — the approved replacement for Chart.js across
 * the app. NO Chart.js, no canvas: a fixed plot rectangle (so the axis frame
 * never shifts), free 2-D pan (drag) and zoom (wheel/pinch) with no limits, and
 * a tap/hover tooltip. Built fresh from the demo that the owner signed off on.
 *
 * Series kinds:
