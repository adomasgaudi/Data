...
const LT: Record<string, string> = {
  ...
  "Showing": "Rodoma",
  " only": " tik",
  "This lift only — not the pattern mix. Tap to merge or separate group members.": "Tik šis pratimas — ne rašto mišinys. Bakstelėkite, kad sujungtumėte ar atskirtumėte grupės narius.",
  "Merged pattern mix — loads scaled to a common equivalent. Tap to change or pick one member.": "Sujungtas rašto mišinys — apkrovos perskaičiuotos į bendrą ekvivalentą. Bakstelėkite keisti arba pasirinkti narį.",
  "Separated members — each lift at its own load. Tap to change or pick one member.": "Atskiri nariai — kiekvienas pratimas savo apkrova. Bakstelėkite keisti arba pasirinkti narį.",
  "Map": "Žemėlapis",
  ...
  "obstacle": "kliūtis",
  "floor height": "grindies aukštis",
  "floorHeight": "grindies aukštis",
  "hanging": "kabantis",
  "on_hands": "ant rankų",
  ...
  "Filter: Off": "Filtras: išj.",
  "Filter: RIR": "Filtras: RIR",
  "Filter: %1RM": "Filtras: %1RM",
  "1RM: Now": "1RM: tada",
  "1RM: Smooth": "1RM: glotn.",
  "≥70%": "≥70%",
  "≥75%": "≥75%",
  "≥80%": "≥80%",
  "≥85%": "≥85%",
